...
import com.example.packyourbags.Adapter.CheckListAdapter;
import com.example.packyourbags.Constants.MyConstants;
import com.example.packyourbags.Data.AppData;
        ...
        switch (item.getItemId()){
            ...
            case R.id.btnDeleteDefault:
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Are you sure?\n\nAs this will delete the data provided Travel Buddy on installation")
            ...
            case R.id.btnReset:
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Are you sure?\n\nAs this will load the default data provided Travel Buddy on installation and will delete the " +
                                "custom data you added in " +header)
                        .setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
