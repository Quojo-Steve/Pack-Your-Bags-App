package com.example.packyourbags.Adapter;
...
import com.example.packyourbags.R;
...
public class CheckListAdapter extends RecyclerView.Adapter<CheckListViewHolder>{
    ...
    public CheckListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new CheckListViewHolder(LayoutInflater.from(context).inflate(R.layout.ckeck_list_item,parent,false));
    }
